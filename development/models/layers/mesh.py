#from meshcnn.models.layers.mesh import *
...
class Mesh:
    ...
    def get_sparse_groups(self):
        return self.history_data['sparse_groups'].pop()

    def get_group_mask(self):
        return self.history_data['group_masks'].pop()
    ...
    def __clean_history(self, groups, pool_mask):
        if self.history_data is not None:
            ...
            self.history_data['sparse_groups'].append(groups.get_sparse_groups())
            self.history_data['group_masks'].append(pool_mask)
